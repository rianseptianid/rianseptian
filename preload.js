...
contextBridge.exposeInMainWorld('api', {
  ...
  getNurearnLiveStreamers: () => ipcRenderer.invoke('nurearn:getLive'),
  ...
  saveGoal: (type, updates) => ipcRenderer.invoke('goal:update', { type, updates }),
  resetGoalProgress: (type) => ipcRenderer.invoke('goal:resetProgress', type),
  resetGoal: (type) => ipcRenderer.invoke('goal:resetProgress', type),
  resetGoalDefault: (type) => ipcRenderer.invoke('goal:resetDefault', type),
  resetGoalToDefault: (type) => ipcRenderer.invoke('goal:resetDefault', type),
  addGoalProgress: (type, amount) => ipcRenderer.invoke('goal:addProgress', { type, amount }),
  getGoalUrl: (type, layout) => ipcRenderer.invoke('overlay:getUrl', type, layout),
  onGoalReached: (cb) => ipcRenderer.on('goal:reached', (_, d) => cb(d)),
  onGoalUpdate: (cb) => ipcRenderer.on('goal:update', (_, d) => cb(d)),
  onGoalsAll: (cb) => ipcRenderer.on('goals:all', (_, d) => cb(d)),
  ...
  updateYoutubeSettings: (partial) => ipcRenderer.invoke('youtube:updateSettings', partial),
  ...
  replayYoutubeSong: (index) => ipcRenderer.invoke('youtube:replaySong', index),
  ...
  playYoutubeInView: (id, user) => ipcRenderer.invoke('youtube:playInView', id, user),
  ...
  youtubeVideoEnded: () => ipcRenderer.invoke('youtube:videoEnded'),
  ...
  onYoutubeNotify: (cb) => ipcRenderer.on('youtube:notify', (_, d) => cb(d)),
