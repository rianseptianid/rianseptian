...
console.log('--- _fireActivity ---');
console.log(deobMethod('async[_0x5c2dd3(0x258'));

console.log('--- testInteraction ---');
console.log(deobMethod('async[_0x5c2dd3(0x1cb'));

console.log('--- _fire ---');
console.log(deobMethod('async[\'_fire\']'));
